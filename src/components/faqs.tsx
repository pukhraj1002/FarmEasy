      ...
      <div className="mt-16 px-8 flex justify-center">
        <Accordion type="single" collapsible className="w-11/12 lg:w-1/2">
          ...
          <AccordionItem value="question-4">
            ...
            <AccordionContent>कृषिCare is free and open source on <Link href="https://github.com/pukhraj1002/कृषिCare" className="underline">GitHub</Link>. We value your input! Your feedback helps us refine and enhance कृषिCare&apos;s capabilities.</AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
    </section>
